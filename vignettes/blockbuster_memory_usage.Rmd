...
The repairing and rebuilding reduces the number of rows in the dataframe for that timestep thus reducing the memory issue but making the code to take longer to run.  
